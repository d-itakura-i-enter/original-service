  ...
  <form method="POST" action="{{ route('boards.store') }}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mx-auto">
   @csrf
    <div class="mb-4">
      ...
      <p class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="名前">{!! $user->user_name !!}</p>
    </div>
    <div class="mb-6">
